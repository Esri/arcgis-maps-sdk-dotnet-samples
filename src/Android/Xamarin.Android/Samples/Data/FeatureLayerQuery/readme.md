...
Input the name of a U.S. state into the text field. When you click "Query", a query is performed and the matching features are highlighted or an error is returned.
