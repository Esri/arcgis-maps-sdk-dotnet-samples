...
namespace ArcGISRuntime.Samples.Buffer
{
    ...
    public class Buffer : Activity
    {
        ...
        // Create a EditText to enter a buffer value (in miles). 
        private EditText _theBufferDistanceEditText;      
        ...
        private void OnMapViewTapped(object sender, GeoViewInputEventArgs e)
        {
            try
            {
                ...
                double theBufferInMiles = System.Convert.ToDouble(_theBufferDistanceEditText.Text);
        ...
        private void CreateLayout()
        {
            ...
            _theBufferDistanceEditText = new EditText(this);
            _theBufferDistanceEditText.Text = "10";
            layout.AddView(_theBufferDistanceEditText);
