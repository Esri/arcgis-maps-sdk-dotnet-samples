...
namespace ArcGISRuntime.Samples.BufferWithUnion
{
    ...
    [ArcGISRuntime.Samples.Shared.Attributes.Sample(
        ...
        "")]
    public class BufferWithUnion : Activity
    {
        ...
        private Button _theUnionBufferButton;
        ...
        private void OnMapViewTapped(object sender, GeoViewInputEventArgs e)
        {
            ...
            catch (System.Exception ex)
            {
                ...
                alertBuilder.SetTitle("Error creating list of map points for buffer!");
        ...
        private void CreateLayout()
        {
            ...
            _theUnionBufferButton = new Button(this);
            _theUnionBufferButton.Text = "Make Unioned Buffer";
            _theUnionBufferButton.Click += OnMakeUnionBufferClicked;
            layout.AddView(_theUnionBufferButton);
