...
Select a date range (between 1998-01-01 and 1998-05-31) and use the button to start the analysis. The results will be shown on the map upon successful completion of the `GeoprocessingJob`.
