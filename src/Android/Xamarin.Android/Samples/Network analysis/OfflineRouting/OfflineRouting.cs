...
namespace ArcGISRuntimeXamarin.Samples.OfflineRouting
{
    ...
    [ArcGISRuntime.Samples.Shared.Attributes.AndroidLayout("OfflineRouting.axml")]
    public class OfflineRouting : Activity
    {
        // Hold references to the UI controls.
        private MapView _myMapView;
        private TextView _instructionLabel;
        private Spinner _travelModeSpinner;
        ...
        private void CreateLayout()
        {
            ...
            SetContentView(Resource.Layout.OfflineRouting);

            // Hook up references to controls.
            _myMapView = FindViewById<MapView>(Resource.Id.OfflineRouting_MyMapView);
            _resetButton = FindViewById<Button>(Resource.Id.OfflineRouting_ResetButton);
            _instructionLabel = FindViewById<TextView>(Resource.Id.OfflineRouting_InstructionLabel);
            _travelModeSpinner = FindViewById<Spinner>(Resource.Id.OfflineRouting_TravelModeSpinner);

            // Set up reset button event.
            _resetButton.Click += ResetButton_Click;

            // Update the label text.
            _instructionLabel.Text = "Tap to add up to 5 stops. The route will display automatically.";
        }
    }
}