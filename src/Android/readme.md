...
* [Integrated Windows Authentication](Xamarin.Android/Samples/Security/IntegratedWindowsAuth/readme.md) - This sample illustrates the use of Windows credentials to access services hosted on a portal secured with Integrated Windows Authentication (IWA).
