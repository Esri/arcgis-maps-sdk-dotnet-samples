...
* [Add graphics with renderer](Xamarin.Android/Samples/GraphicsOverlay/AddGraphicsRenderer/readme.md) - A renderer allows you to change the style of all graphics in a graphics overlay by referencing a single symbol style. A renderer will only affect graphics that do not specify their own symbol style.
...
* [Basic readme template](Xamarin.Android/Samples/Layers/DisplayDimensions/readme.md) - 
