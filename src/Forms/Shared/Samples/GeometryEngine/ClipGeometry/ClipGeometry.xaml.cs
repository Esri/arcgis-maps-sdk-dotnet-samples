...
namespace ArcGISRuntime.Samples.ClipGeometry
{
    ...
    public partial class ClipGeometry : ContentPage
    {
        ...
        private async void Initialize()
        {
            ...
            Colors2 coloradoFillColor = Colors2.FromArgb(34, 0, 0, 255);
        ...
        private void ClipButton_Clicked(object sender, EventArgs e)
        {
            try
            {
                ...
                Colors2 clipGeometriesFillColor = Colors2.FromArgb(34, 0, 0, 255);
