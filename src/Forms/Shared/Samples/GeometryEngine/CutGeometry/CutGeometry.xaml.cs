...
namespace ArcGISRuntime.Samples.CutGeometry
{
    [ArcGISRuntime.Samples.Shared.Attributes.Sample(
        ...
        "")]
    public partial class CutGeometry : ContentPage
    {
        ...
        private void CutButton_Clicked(object sender, EventArgs e)
        {
            try
            {
                ...
                SimpleLineSymbol canadaSideSimpleLineSymbol = new SimpleLineSymbol(SimpleLineSymbolStyle.Null, Colors.Blue, 0);
                ...
                SimpleFillSymbol canadaSideSimpleFillSymbol = new SimpleFillSymbol(SimpleFillSymbolStyle.ForwardDiagonal, Colors.Green, canadaSideSimpleLineSymbol);
                ...
                SimpleLineSymbol usaSideSimpleLineSymbol = new SimpleLineSymbol(SimpleLineSymbolStyle.Null, Colors.Blue, 0);

                // Create the simple fill symbol for the USA side of Lake Superior graphic - comprised of a fill style, fill color and outline.
                SimpleFillSymbol usaSideSimpleFillSymbol = new SimpleFillSymbol(SimpleFillSymbolStyle.ForwardDiagonal, Colors.Yellow, usaSideSimpleLineSymbol);
