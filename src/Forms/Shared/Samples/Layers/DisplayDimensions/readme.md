...
4. Control the dimension layer's visibility with `_dimensionLayer.IsVisible` and set a definition expression with `dimensionLayer.setDefinitionExpression(String)`.
