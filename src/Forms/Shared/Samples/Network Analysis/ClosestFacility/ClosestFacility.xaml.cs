...
namespace ArcGISRuntime.Samples.ClosestFacility
{
    [ArcGISRuntime.Samples.Shared.Attributes.Sample(
        ...
        "")]
    public partial class ClosestFacility : ContentPage
    {
        ...
        private void MyMapView_GeoViewTappedAsync(object sender, Esri.ArcGISRuntime.Xamarin.Forms.GeoViewInputEventArgs e)
        {
