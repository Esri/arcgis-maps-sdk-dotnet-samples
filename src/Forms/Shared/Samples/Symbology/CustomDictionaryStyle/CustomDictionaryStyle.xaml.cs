...
namespace ArcGISRuntimeXamarin.Samples.CustomDictionaryStyle
{
    ...
    public partial class CustomDictionaryStyle : ContentPage
    {
        ...
        private void LocalStyleButtonClicked(object sender, EventArgs e)
        {
            ...
            LocalStyleButton.IsEnabled = false;
            WebStyleButton.IsEnabled = true;
        }
        ...
        private void WebStyleButtonClicked(object sender, EventArgs e)
        {
            ...
            LocalStyleButton.IsEnabled = true;
            WebStyleButton.IsEnabled = false;
        }
    }
}