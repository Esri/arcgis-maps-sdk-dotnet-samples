...
* [Add graphics with renderer](Shared/Samples/GraphicsOverlay/AddGraphicsRenderer/readme.md) - A renderer allows you to change the style of all graphics in a graphics overlay by referencing a single symbol style.
...
* [Feature layer definition expression](Shared/Samples/Layers/FeatureLayerDefinitionExpression/readme.md) - Limit the features displayed on a map with a definition expression.
...
* [Integrated Windows Authentication](Shared/Samples/Security/IntegratedWindowsAuth/readme.md) - Connect to an IWA secured Portal and search for maps.
