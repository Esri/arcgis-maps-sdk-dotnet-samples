...
5. To scale symbols, read the platform's system text-scale factor and subscribe to text-scale changes. Scale `MultilayerPointSymbol.Size` by the system text-scale factor.
