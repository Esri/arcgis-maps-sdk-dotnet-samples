...
5. To scale symbols, read the platform's system text-scale factor and subscribe to text-scale changes. Multiply the base size by the text-scale factor and set `MultilayerPointSymbol.Size` to scale all symbol layers proportionately.
