...
namespace ArcGIS.Samples.ShowExploratoryViewshedFromPointInScene
{
    [ArcGIS.Samples.Shared.Attributes.Sample(
        ...
        instructions: "Use the sliders to change the properties (heading, pitch, etc.) of the exploratory viewshed and see them updated in real time. Tap on the map to move the exploratory viewshed.",
