...
namespace ArcGIS.Samples.ShowExploratoryViewshedFromPointInScene
{
    [ArcGIS.Samples.Shared.Attributes.Sample(
        ...
        instructions: "Tap anywhere in the scene to 'pick up' the exploratory viewshed observer location. Move the mouse to see the exploratory viewshed observer location update in real time. Tap again to 'drop' the exploratory viewshed observer location.",
        tags: new[] { "3D", "exploratory viewshed", "frustum", "scene", "visibility analysis" })]
    public partial class ShowExploratoryViewshedFromPointInScene : ContentPage
    {
        ...
        public ShowExploratoryViewshedFromPointInScene()
        {
            InitializeComponent();
