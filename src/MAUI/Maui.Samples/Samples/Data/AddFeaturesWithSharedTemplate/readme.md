...
Hover over a shared template to view its description. Select a template and tap on the map to place the geometry. Choose "Complete" to create the feature, "Save" to apply local edits, or "Undo" to discard them.
