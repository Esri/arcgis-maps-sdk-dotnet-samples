...
namespace ArcGIS.Samples.GenerateGeodatabaseReplica
{
    ...
    public partial class GenerateGeodatabaseReplica : ContentPage
    {
        ...
        private async Task StartGeodatabaseGeneration()
        {
            ...
            MyProgressGrid.IsVisible = false;
        ...
        private async Task HandleGenerationStatusChange(GenerateGeodatabaseJob job, Geodatabase resultGdb)
        {
            ...
            if (job.Status == JobStatus.Succeeded)
            {
                ...
                await Application.Current.Windows[0].Page.DisplayAlertAsync("Alert", "Since no edits will be made, the local geodatabase has been unregistered per best practice.", "OK");
            ...
            if (job.Status == JobStatus.Failed)
            {
                ...
                await Application.Current.Windows[0].Page.DisplayAlertAsync("Alert", message, "OK");
            }
        }
        ...
        private void UpdateProgressBar()
        {
            ...
            Microsoft.Maui.ApplicationModel.MainThread.BeginInvokeOnMainThread(() =>
            {
                ...
                MyProgressLabel.Text = $"{_generateGdbJob.Progress}%";
            });
        }
    }
}