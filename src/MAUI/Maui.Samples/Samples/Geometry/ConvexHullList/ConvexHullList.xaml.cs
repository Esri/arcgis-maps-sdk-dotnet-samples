...
namespace ArcGIS.Samples.ConvexHullList
{
    ...
    public partial class ConvexHullList : ContentPage
    {
        ...
        private void ConvexHullListButton_Clicked(object sender, EventArgs e)
        {
            try
            {
                // Get the boolean value whether to create a single convex hull (true) or independent convex hulls (false).
                bool unionBool = (bool)ConvexHullListSwitch.IsToggled;
            ...
            catch (Exception ex)
            {
                ...
                DisplayAlertAsync("Geometry Engine Failed", "Error creating convex hull: " + ex.Message, "OK");
            }
        }
