...
namespace ArcGIS.Samples.ShowViewshedCalculatedFromGeoprocessingTask
{
    [ArcGIS.Samples.Shared.Attributes.Sample(
        name: "Show viewshed calculated from geoprocessing task",
    ...
    public partial class ShowViewshedCalculatedFromGeoprocessingTask : ContentPage
    {
        ...
        public ShowViewshedCalculatedFromGeoprocessingTask()
        {
            InitializeComponent();
