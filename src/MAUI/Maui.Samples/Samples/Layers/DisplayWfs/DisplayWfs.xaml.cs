...
namespace ArcGIS.Samples.DisplayWfs
{
    ...
    public partial class DisplayWfs : ContentPage
    {
        ...
        private async Task Initialize()
        {
            ...
            {
                await Application.Current.Windows[0].Page.DisplayAlertAsync("Error", e.ToString(), "Couldn't load sample.");
                Debug.WriteLine(e);
            }
        }
        ...
        private async void MapView_NavigationCompleted(object sender, EventArgs e)
        {
            ...
            {
                await Application.Current.Windows[0].Page.DisplayAlertAsync("Error", exception.ToString(), "Couldn't populate table.");
