...
namespace ArcGIS.Samples.NavigateRouteRerouting
{
    ...
    public partial class NavigateRouteRerouting : ContentPage, IDisposable
    {
        ...
        private readonly string _networkGeodatabasePath = DataManager.GetDataFolder("df193653ed39449195af0c9725701dca", "sandiego.geodatabase");
