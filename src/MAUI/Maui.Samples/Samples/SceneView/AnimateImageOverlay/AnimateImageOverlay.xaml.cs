...
namespace ArcGIS.Samples.AnimateImageOverlay
{
    ...
    public partial class AnimateImageOverlay : ContentPage, IDisposable
    {
        ...
        private async Task Initialize()
        {
            ...
            {
                await Application.Current.Windows[0].Page.DisplayAlertAsync("Error", "This sample is only supported for .NET MAUI in x64. Run the sample viewer in x64 to use this sample.", "Exit");
                return;
            }
