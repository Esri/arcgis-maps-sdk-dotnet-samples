    ...
    public partial class ChooseCameraController : ContentPage
    {
        ...
        private async Task Initialize()
        {
            ...
            catch (Exception ex)
            {
                ...
                await Application.Current.Windows[0].Page.DisplayAlertAsync("Error", "Loading plane model failed. Sample failed to initialize.", "OK");
                return;
            }
        ...
        private async void OnButtonClicked(object sender, EventArgs e)
        {
            try
            {
                ...
                string selectedCamera =
                    await Application.Current.Windows[0].Page.DisplayActionSheetAsync("Select camera controller", "Cancel", null, _controllers);
