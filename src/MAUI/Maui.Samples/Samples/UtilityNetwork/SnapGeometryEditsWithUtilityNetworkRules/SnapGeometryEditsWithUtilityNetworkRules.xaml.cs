    ...
    public partial class SnapGeometryEditsWithUtilityNetworkRules
    {
        ...
        private async Task InitializeAsync()
        {
            try
            {
                ...
                // Show the UI.
                SnappingControls.IsVisible = true;
            }
            catch (Exception ex)
            {
        ...
        private void GeometryEditorButton_Click(object sender, EventArgs e)
        {
...
#if ANDROID || IOS
            // On mobile default to reticle vertex tool for better touch experience.
            MyMapView.GeometryEditor.Tool = new ReticleVertexTool();
#endif
        ...
        {
            InstructionsLabel.IsVisible = _selectedFeature == null;
            SelectedFeaturePanel.IsVisible = _selectedFeature != null;
        }
        ...
        private void SnapSourcesPopupBackground_Tapped(object sender, TappedEventArgs e)
        {
            SnapSourcesPopup.IsVisible = false;
            SnapSourcesPopupBackground.IsVisible = false;
        }

        private void SnapSourcesButton_Clicked(object sender, EventArgs e)
        {
            SnapSourcesPopup.IsVisible = true;
            SnapSourcesPopupBackground.IsVisible = true;
        }
    }
    ...
    public class SnapSourceSettingsVM
    {
        ...
        private async Task SetSymbolAsync()
        {
            ...
            if (symbol != null)
            {
                ...
                _symbol = await Esri.ArcGISRuntime.Maui.RuntimeImageExtensions.ToImageSourceAsync(swatch);
            }
        }
