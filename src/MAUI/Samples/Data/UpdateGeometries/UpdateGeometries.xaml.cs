...
namespace ArcGISRuntimeMaui.Samples.UpdateGeometries
{
    ...
    public partial class UpdateGeometries : ContentPage
    {
        ...
        private async void MoveSelectedFeature(Esri.ArcGISRuntime.Maui.GeoViewInputEventArgs tapEventDetails)
        {
            try
            {
        ...
        private async void TrySelectFeature(Esri.ArcGISRuntime.Maui.GeoViewInputEventArgs tapEventDetails)
        {
            try
            {
