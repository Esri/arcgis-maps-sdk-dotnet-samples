...
namespace ArcGISRuntimeSamples.ApplyMosaicRule
{
    ...
    public partial class ApplyMosaicRule : ContentPage
    {
        ...
        private async Task Initialize()
        {
            ...
            MosaicRulesPicker.ItemsSource = _mosaicRules.Keys.ToList();
            MosaicRulesPicker.SelectedIndex = 0;
        }

        private void MosaicRulesBox_SelectedIndexChanged(object sender, System.EventArgs e)
        {
            // Change the mosaic rule used for the image service raster.
            _imageServiceRaster.MosaicRule = _mosaicRules[MosaicRulesPicker.SelectedItem as string];
        }
    }
}