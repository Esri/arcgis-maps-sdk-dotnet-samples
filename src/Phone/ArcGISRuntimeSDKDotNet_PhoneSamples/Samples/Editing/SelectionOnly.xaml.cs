...
namespace ArcGISRuntimeSDKDotNet_StoreSamples.Samples
{
    ...
    public partial class SelectionOnly : Page
    {
        ...
        private async void AddButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                ...
                EditButton.IsEnabled = true;
                 var dialog = new MessageDialog("Do you want to add new feature to your database?", "Add feature");
        ...
        private async void DeleteButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                var dialog = new MessageDialog("Are you sure you want to delete feature from the database?", "Delete feature");
                dialog.Commands.Add(new UICommand("OK", new UICommandInvokedHandler(async (command) =>
                {
