...
namespace ArcGISRuntimeSDKDotNet_StoreSamples.Samples
{
    ...
    public partial class SelectionOnly : Page
    {
        ...
        {
            if (MyMapView.Editor.IsActive || isEditing)
                return;
            var dynamicLayer = GetArcGISDynamicMapServiceLayer();
            var layer = GetGraphicsLayer();
        ...
        private async void AddButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                ...
                EditButton.DataContext = graphic;
                EditButton.IsEnabled = true;
                var dialog = new MessageDialog("Do you want to save new feature?", "Add feature");
        ...
        private async void EditButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                ...
                var dialog = new MessageDialog("Do you want to save the geometry change?", "Update feature");
                dialog.Commands.Add(new UICommand("OK", new UICommandInvokedHandler(async (command) =>
                {
        ...
        private async void DeleteButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                var dialog = new MessageDialog("Are you sure you want to delete feature?", "Delete feature");
                dialog.Commands.Add(new UICommand("OK", new UICommandInvokedHandler(async (command) =>
                {
