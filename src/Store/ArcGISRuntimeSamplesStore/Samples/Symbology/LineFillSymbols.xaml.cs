...
{
	/// <summary>
	/// Shows how to create Line and Fill Symbol (SimpleLineSymbol, SimpleFillSymbol, PictureFillSymbol) and add graphics using the symbols.
	/// </summary>
		...
		private async Task SetupSymbolsAsync()
		{
			try
			{
				...
				_symbols = new List<SampleSymbol>()
				{
					...
					new SampleSymbol(new PictureFillSymbol() { Outline = blackOutlineSymbol, Width = 24, Height = 24 }, "ms-appx:///ArcGISRuntimeSamplesStore/Assets/x-24x24.png"),
