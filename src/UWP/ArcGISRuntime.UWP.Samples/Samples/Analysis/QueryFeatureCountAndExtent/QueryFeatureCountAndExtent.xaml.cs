...
namespace ArcGISRuntime.UWP.Samples.QueryFeatureCountAndExtent
{
    public partial class QueryFeatureCountAndExtent
    {
        ...
        private async void btnStateCount_Click(object sender, Windows.UI.Xaml.RoutedEventArgs e)
        {
        ...
        private async void btnExtentCount_Click(object sender, Windows.UI.Xaml.RoutedEventArgs e)
        {
