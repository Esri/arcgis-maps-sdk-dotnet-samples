...
Namespace SketchOnMap
    Partial Public NotInheritable Class SketchOnMapVB
...
#End Region
        ...
        Private Async Sub DrawButtonClick(sender As Object, e As RoutedEventArgs)
            ...
            Catch ex As Exception
                ...
                ' Report exceptions
                Dim dialog As MessageDialog = New MessageDialog("Error drawing graphic shape: " & ex.Message)
                dialog.ShowAsync()
        ...
        Private Async Sub EditButtonClick(sender As Object, e As RoutedEventArgs)
            ...
            Catch ex As Exception
                ...
                ' Report exceptions
                Dim dialog As MessageDialog = New MessageDialog("Error editing shape: " + ex.Message)
                dialog.ShowAsync()
            End Try
        End Sub
    End Class
