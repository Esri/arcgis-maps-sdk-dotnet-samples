...
Namespace UseDistanceCompositeSym
    ...
    Public Class UseDistanceCompositeSymVB
        ...
        Private _modelFilePath As String = "ms-appx:///ArcGISRuntime.UWP.Samples/Resources/SkyCrane/SkyCrane.lwo"
        ...
        Private Async Function CreateCompositeSymbolAsync() As Task(Of DistanceCompositeSceneSymbol)
            ...
            Dim modelSym As ModelSceneSymbol = Await ModelSceneSymbol.CreateAsync(New Uri(_modelFilePath), 0.01)
