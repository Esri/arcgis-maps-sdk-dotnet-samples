...
namespace ArcGISRuntime.UWP.Samples.EditFeatureLinkedAnnotation
{
    ...
    public partial class EditFeatureLinkedAnnotation
    {
        ...
        private void ShowEditableAttributes()
        {
            ...
            AttributesBorder.Visibility = Windows.UI.Xaml.Visibility.Visible;
        ...
        private void CancelClick(object sender, Windows.UI.Xaml.RoutedEventArgs e)
        {
            ...
            AttributesBorder.Visibility = Windows.UI.Xaml.Visibility.Collapsed;
        }

        private async void OkClick(object sender, Windows.UI.Xaml.RoutedEventArgs e)
        {
            try
            {
