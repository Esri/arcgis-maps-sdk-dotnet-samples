    ...
    public partial class ClipGeometry
    {
        ...
        private async void Initialize()
        {
            ...
            SimpleLineSymbol coloradoSimpleLineSymbol = new SimpleLineSymbol(
                SimpleLineSymbolStyle.Solid, Windows.UI.Colors.Blue, 4);

            // Create the color that will be used as the fill for the Colorado graphic. It will be a semi-transparent, blue color.
            Windows.UI.Color coloradoFillColor = Windows.UI.Color.FromArgb(34, 0, 0, 255);
            ...
            SimpleLineSymbol clipGeomtriesSimpleLineSymbol = new SimpleLineSymbol(
                SimpleLineSymbolStyle.Dot, Windows.UI.Colors.Red, 5);
        ...
        private async void ClipButton_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                Windows.UI.Color clipGeometriesFillColor = Windows.UI.Color.FromArgb(34, 0, 0, 255);
