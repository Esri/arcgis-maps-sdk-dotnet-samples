...
namespace ArcGISRuntime.UWP.Samples.CutGeometry
{
    ...
    public partial class CutGeometry
    {
        ...
        public CutGeometry()
        {
            ...
            SimpleLineSymbol lakeSuperiorSimpleLineSymbol = new SimpleLineSymbol(SimpleLineSymbolStyle.Solid, Windows.UI.Colors.Blue, 4);

            // Create the color that will be used for the fill the Lake Superior graphic. It will be a semi-transparent, blue color.
            Windows.UI.Color lakeSuperiorFillColor = Windows.UI.Color.FromArgb(34, 0, 0, 255);
            ...
            SimpleLineSymbol countryBorderSimpleLineSymbol = new SimpleLineSymbol(SimpleLineSymbolStyle.Dot, Windows.UI.Colors.Red, 5);
