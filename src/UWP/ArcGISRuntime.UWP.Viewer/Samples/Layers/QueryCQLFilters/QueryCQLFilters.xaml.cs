...
namespace ArcGISRuntime.UWP.Samples.QueryCQLFilters
{
    ...
    public partial class QueryCQLFilters
    {
        ...
        private async Task LoadService()
        {
            ...
            {
                await new MessageDialog(ex.Message, "Error loading/populating service").ShowAsync();
            }
            finally
            {
                // Update the UI.
        ...
        public QueryParameters CreateQueryParameters()
        {
            ...
            {
                DateTime startDate = (StartDatePicker.SelectedDate is DateTimeOffset userStart) ? userStart.DateTime : DateTime.MinValue;
                DateTime endDate = (EndDatePicker.SelectedDate is DateTimeOffset userEnd) ? userEnd.DateTime : new DateTime(9999, 12, 31);
        ...
        private async void ApplyQuery_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                await new MessageDialog(ex.Message, "Error querying/populating service").ShowAsync();
            }
            finally
            {
                // Update the UI.
        ...
        private void ResetQuery_Click(object sender, RoutedEventArgs e)
        {
