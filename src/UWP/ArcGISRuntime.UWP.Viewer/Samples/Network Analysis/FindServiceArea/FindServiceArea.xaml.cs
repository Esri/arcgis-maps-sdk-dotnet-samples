...
namespace ArcGISRuntime.UWP.Samples.FindServiceArea
{
    ...
    {     
        ...
        private void AddBarrier_Click(object sender, RoutedEventArgs e)
        {
        ...
        private async void ShowServiceAreas_Click(object sender, RoutedEventArgs e)
        {
            ...
            //Create the service area to be used.
            ...
            if (_serviceAreaFacilities.Count > 0)
            {
                ...
                catch (Esri.ArcGISRuntime.Http.ArcGISWebException exception)
                {
                    ...
                    {
                        var message = new MessageDialog("Facility not within San Diego area!", "").ShowAsync();
                    }
                    else
                    {
                        var message = new MessageDialog("An ArcGIS web exception occurred. \n" + exception.Message.ToString(), "").ShowAsync();
                    }
                }
            }
            else
            {
                var message = new MessageDialog("Must have at least 1 Facility!", "").ShowAsync();
            }
        }
