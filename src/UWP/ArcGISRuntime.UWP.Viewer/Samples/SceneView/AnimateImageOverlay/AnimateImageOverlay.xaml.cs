...
namespace ArcGISMapsSDK.UWP.Samples.AnimateImageOverlay
{
    ...
    [ArcGISMapsSDK.Samples.Shared.Attributes.OfflineData("9465e8c02b294c69bdb42de056a23ab1")]
    public partial class AnimateImageOverlay
    {
        ...
        private void ChangeOpacity(object sender, Windows.UI.Xaml.Controls.Primitives.RangeBaseValueChangedEventArgs e)
        {
            // Update the opacity of the image overlay.
            if (_imageOverlay != null) _imageOverlay.Opacity = e.NewValue / 100;
        }
