...
- **Map**
    ...
    * [Read a GeoPackage](ArcGISRuntime.UWP.Samples/Samples/Data/ReadGeoPackage)
...
- **Raster Layers**
    ...
    * [Raster layer (file)](ArcGISRuntime.UWP.Samples/Samples/Layers/RasterLayerFile)
    ...
    * [Raster RGB renderer](ArcGISRuntime.UWP.Samples/Samples/Layers/RasterRgbRenderer)
    ...
    * [Raster hillshade renderer](ArcGISRuntime.UWP.Samples/Samples/Layers/RasterHillshade)
    ...
    * [Blend renderer](ArcGISRuntime.UWP.Samples/Samples/Layers/ChangeBlendRenderer)
...
- **Feature Layers**
    ...
    * [Feature layer rendering mode (Scene)](ArcGISRuntime.UWP.Samples/Samples/Layers/FeatureLayerRenderingModeScene)
...
- **Feature Tables**
    ...
    * [Symbolize a shapefile](ArcGISRuntime.UWP.Samples/Samples/Data/SymbolizeShapefile)

    This sample demonstrates how to apply a custom renderer to a shapefile displayed by a feature layer.

    * [List related features](ArcGISRuntime.UWP.Samples/Samples/Data/ListRelatedFeatures)
...
- **Symbology**
    ...
    * [Simple renderer](ArcGISRuntime.UWP.Samples/Samples/Symbology/SimpleRenderers)
...
- **Geoprocessing**
    ...
    * [Viewshed (GeoElement)](ArcGISRuntime.UWP.Samples/Samples/Analysis/ViewshedGeoElement)
    ...
    * [Viewshed (Location)](ArcGISRuntime.UWP.Samples/Samples/Analysis/ViewshedLocation)
    ...
    * [Line of Sight (GeoElement)](ArcGISRuntime.UWP.Samples/Samples/Analysis/LineOfSightGeoElement)
    ...
    * [Query feature count and extent](ArcGISRuntime.UWP.Samples/Samples/Analysis/QueryFeatureCountAndExtent)
...
* [FeatureLayerExtrusion](ArcGISRuntime.UWP.Samples/Samples/Symbology/FeatureLayerExtrusion)
...
* [Display scene](ArcGISRuntime.UWP.Samples/Samples/Layers/DisplayScene)
...
- **Projection**
    ...
    * [List transformations by suitability](ArcGISRuntime.UWP.Samples/Samples/GeometryEngine/ListTransformations)
