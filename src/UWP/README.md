...
- **Layers and Data**
    ...
    * [Read shapefile metadata](ArcGISRuntime.UWP.Samples/Samples/LayersAndData/ReadShapefileMetadata)
...
- **Maps and Visualization**
    ...
    * [Open Map (URL)](ArcGISRuntime.UWP.Samples/Samples/MapsAndVisualization/OpenMapUrl)
