...
namespace ArcGISRuntime.WPF.Samples.BufferWithUnion
{
    [ArcGISRuntime.Samples.Shared.Attributes.Sample(
        ...
        "")]
    public partial class BufferWithUnion
    {
        ...
        private void Buffer_Button_Click(object sender, RoutedEventArgs e)
        {
            try
            {
