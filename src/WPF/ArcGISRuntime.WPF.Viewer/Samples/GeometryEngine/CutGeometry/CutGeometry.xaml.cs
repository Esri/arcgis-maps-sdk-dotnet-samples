...
namespace ArcGISRuntime.WPF.Samples.CutGeometry
{
    ...
    public partial class CutGeometry
    {
        ...
        public CutGeometry()
        {
            ...
            SimpleLineSymbol lakeSuperiorSimpleLineSymbol = new SimpleLineSymbol(SimpleLineSymbolStyle.Solid, System.Windows.Media.Colors.Blue, 4);

            // Create the color that will be used for the fill the Lake Superior graphic. It will be a semi-transparent, blue color.
            System.Windows.Media.Color lakeSuperiorFillColor = System.Windows.Media.Color.FromArgb(34, 0, 0, 255);
            ...
            SimpleLineSymbol countryBorderSimpleLineSymbol = new SimpleLineSymbol(SimpleLineSymbolStyle.Dot, System.Windows.Media.Colors.Red, 5);
