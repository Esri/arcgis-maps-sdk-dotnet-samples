...
namespace ArcGISRuntime.WPF.Samples.GeodesicOperations
{
    ...
    public partial class GeodesicOperations
    {
        ...
        private void Initialize()
        {
            ...
            SimpleMarkerSymbol startMarker = new SimpleMarkerSymbol(SimpleMarkerSymbolStyle.Circle, System.Windows.Media.Colors.Blue, 10);
            ...
            {
                Symbol = new SimpleLineSymbol(SimpleLineSymbolStyle.Dash, System.Windows.Media.Colors.Blue, 5)
            };
