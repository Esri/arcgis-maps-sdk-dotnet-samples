...
ArcGIS tiled layers do not support reprojection, query, select, identify, or editing. Visit the [ArcGIS Online Developer's portal](https://developers.arcgis.com/net/latest/wpf/guide/layer-types-described.htm) to Learn more about the characteristics of ArcGIS tiled layers.
