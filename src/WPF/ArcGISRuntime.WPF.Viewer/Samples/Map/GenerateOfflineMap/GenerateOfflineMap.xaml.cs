...
namespace ArcGISRuntime.WPF.Samples.GenerateOfflineMap
{
    ...
    public partial class GenerateOfflineMap
    {
        ...
        // The extent of the data to take offline (a portion of Naperville Illinois, USA).
        ...
        // - The ID for a web map item hosted on the server (the ID below is for a water network map of Naperville IL).
