...
namespace ArcGIS.WPF.Samples.AnalyzeTerrainSuitabilityFromSlopeAndAspect
{
    ...
    public partial class AnalyzeTerrainSuitabilityFromSlopeAndAspect
    {
        ...
        private void OnAnalysisViewStateChanged(object sender, AnalysisViewStateChangedEventArgs e)
        {
            ...
            if (e.AnalysisViewState.Status == AnalysisViewStatus.Error && !_analysisErrorReported)
            {
                ...
                MessageBox.Show(e.AnalysisViewState.Error?.Message, "Error displaying analysis");
            }
        }
    }
}
