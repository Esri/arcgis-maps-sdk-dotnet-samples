...
namespace ArcGIS.WPF.Samples.ShowLineOfSightAnalysisOnMap
{
    ...
    public partial class ShowLineOfSightAnalysisOnMap
    {
        ...
        private List<ObserverResultSummary> BuildObserverSummaries(IReadOnlyList<LineOfSight> results)
        {
            ...
            for (int i = 0; i < results.Count; i++)
            {
                ...
                summaries.Add(new ObserverResultSummary { ObserverBrush = brush, InfoText = infoText });
            }
            return summaries;
        }
    ...
    {
        public SolidColorBrush ObserverBrush { get; set; }
