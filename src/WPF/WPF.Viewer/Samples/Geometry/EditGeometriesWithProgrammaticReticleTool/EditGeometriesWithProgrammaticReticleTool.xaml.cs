...
namespace ArcGIS.WPF.Samples.EditGeometriesWithProgrammaticReticleTool
{
    ...
    public partial class EditGeometriesWithProgrammaticReticleTool
    {
        ...
        private async void MyMapView_GeoViewTapped(object sender, GeoViewInputEventArgs e)
        {
            ...
            {
                // Report exceptions.
                MessageBox.Show("Error editing: " + ex.Message, ex.GetType().Name, MessageBoxButton.OK, MessageBoxImage.Error);
