...
namespace ArcGIS.WinUI.Samples.ShowExploratoryViewshedFromGeoelementInScene
{
    ...
    public partial class ShowExploratoryViewshedFromGeoelementInScene
    {
        ...
        public ShowExploratoryViewshedFromGeoelementInScene()
        {
            InitializeComponent();
        ...
        private void AnimateTank()
        {
            ...
            GeodeticDistanceResult distance = location.DistanceGeodetic(_tankEndPoint, 
                _metersUnit, _degreesUnit, GeodeticCurveType.Geodesic);
