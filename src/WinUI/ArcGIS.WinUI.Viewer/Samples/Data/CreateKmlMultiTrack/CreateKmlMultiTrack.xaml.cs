...
namespace ArcGIS.WinUI.Samples.CreateKmlMultiTrack
{
    ...
    public partial class CreateKmlMultiTrack
    {
        ...
        private async Task LoadLocalKmlFile()
        {
            ...
            var tracksDictionary = new Dictionary<string, object>();
        ...
        /// </summary>
        private void TracksComboBox_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            if (TracksComboBox.ItemsSource != null)
            {
                // Get the value as stored in the combo box.
                var selectedGeometry = ((KeyValuePair<string, object>)TracksComboBox.SelectedItem).Value as Geometry;
