...
One use case for 3D tiles layer in a scene is assisting with visual analysis, such as an exploratory line of sight analysis. An exploratory [line of sight analysis](https://developers.arcgis.com/documentation/mapping-apis-and-services/spatial-analysis/tutorials/apis/display-a-line-of-sight/) can be used to assess whether a view is obstructed between an observer and a target.
