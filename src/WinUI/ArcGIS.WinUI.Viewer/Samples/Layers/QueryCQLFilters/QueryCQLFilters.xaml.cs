...
namespace ArcGIS.WinUI.Samples.QueryCQLFilters
{
    ...
    public partial class QueryCQLFilters
    {
        private IReadOnlyList<string> DefaultWhereClause = new[]
       {
        ...
        private async Task Initialize()
        {
            ...
            {
                await new MessageDialog2(ex.Message, "Error loading/populating service").ShowAsync();
            }
            finally
            {
                // Update the UI.
        ...
        private async void ApplyQuery_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                await new MessageDialog2(ex.Message, "Error querying/populating service").ShowAsync();
            }
            finally
            {
                // Update the UI.
