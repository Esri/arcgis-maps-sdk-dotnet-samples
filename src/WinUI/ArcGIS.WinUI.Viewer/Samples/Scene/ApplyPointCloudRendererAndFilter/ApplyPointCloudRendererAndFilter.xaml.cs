...
namespace ArcGIS.WinUI.Samples.ApplyPointCloudRendererAndFilter
{
    ...
    public partial class ApplyPointCloudRendererAndFilter
    {
        ...
        private void RendererRadioButton_Checked(object sender, RoutedEventArgs e)
        {
            if (_pointCloudLayer == null || _renderers == null)
            {
                return;
            }

            int rendererIndex;
            if (ReferenceEquals(sender, RgbRendererRadioButton))
            {
                rendererIndex = 0;
            }
            else if (ReferenceEquals(sender, StretchRendererRadioButton))
            {
                rendererIndex = 1;
            }
            else if (ReferenceEquals(sender, ClassBreaksRendererRadioButton))
            {
                rendererIndex = 2;
            }
            else if (ReferenceEquals(sender, UniqueValueRendererRadioButton))
            {
                rendererIndex = 3;
            }
            else
        ...
        private void PointSizeSlider_ValueChanged(object sender, Microsoft.UI.Xaml.Controls.Primitives.RangeBaseValueChangedEventArgs e)
        {
            if (_pointCloudLayer?.Renderer?.SizeAlgorithm is PointCloudSplatAlgorithm splatAlgorithm)
            {
        ...
        private void ValueFilterModeRadioButton_Checked(object sender, RoutedEventArgs e)
        {
            UpdateValueFilter();
        }

        private void ValueFilterCheckBox_CheckedChanged(object sender, RoutedEventArgs e)
        {
            UpdateValueFilter();
        }
        ...
        private void UpdateValueFilter()
        {
            ...
            if (GroundCheckBox.IsChecked == true)
            {
                selectedClassCodes.Add(2);
            }
            if (HighVegetationCheckBox.IsChecked == true)
            {
                selectedClassCodes.Add(5);
            }
            if (BuildingCheckBox.IsChecked == true)
            {
            ...
            PointCloudValueFilterMode mode = ExcludeValueFilterRadioButton.IsChecked == true
        ...
        private void ClearValueFilterButton_Click(object sender, RoutedEventArgs e)
        {
        ...
        private void ReturnFilterCheckBox_CheckedChanged(object sender, RoutedEventArgs e)
        {
            UpdateReturnFilter();
        }
        ...
        private void ClearReturnFilterButton_Click(object sender, RoutedEventArgs e)
        {
        ...
        private void BitfieldFilterCheckBox_CheckedChanged(object sender, RoutedEventArgs e)
        {
            ...
            if (ReferenceEquals(sender, RequireSetCheckBox) && RequireSetCheckBox.IsChecked == true)
            {
                RequireClearCheckBox.IsChecked = false;
            }
            else if (ReferenceEquals(sender, RequireClearCheckBox) && RequireClearCheckBox.IsChecked == true)
            {
        ...
        private void UpdateBitfieldFilter()
        {
            ...
            if (RequireClearCheckBox.IsChecked == true)
            {
                requiredClearBits.Add(ScanDirectionFlagBit);
            }
            if (RequireSetCheckBox.IsChecked == true)
            {
