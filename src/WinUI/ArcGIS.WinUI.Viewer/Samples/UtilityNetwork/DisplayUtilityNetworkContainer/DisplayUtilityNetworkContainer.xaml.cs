...
namespace ArcGIS.WinUI.Samples.DisplayUtilityNetworkContainer
{
    ...
    public partial class DisplayUtilityNetworkContainer
    {
        ...
        private async Task Initialize()
        {
            ...
            var symbologyKey = new Dictionary<UtilityAssociationType, Microsoft.UI.Xaml.Media.ImageSource>();
            ...
            try
            {
                ...
                // The feature service url contains a utility network used to find associations shown in this sample.Add commentMore actions
        ...
        private async Task IdentifyContainer(Windows.Foundation.Point position)
        {
            try
            {
