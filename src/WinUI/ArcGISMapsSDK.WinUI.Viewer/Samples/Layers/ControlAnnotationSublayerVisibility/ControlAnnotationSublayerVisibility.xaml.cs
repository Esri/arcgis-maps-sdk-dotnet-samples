...
namespace ArcGISMapsSDK.WinUI.Samples.ControlAnnotationSublayerVisibility
{
    ...
    public partial class ControlAnnotationSublayerVisibility
    {
        ...
        private void OpenCheckBoxChanged(object sender, Microsoft.UI.Xaml.RoutedEventArgs e)
        {
            // Set the visibility of the sub layer.
            if (_openSublayer != null) _openSublayer.IsVisible = OpenCheckBox.IsChecked == true;
        }

        private void ClosedCheckBoxChanged(object sender, Microsoft.UI.Xaml.RoutedEventArgs e)
        {
            // Set the visibility of the sub layer.
