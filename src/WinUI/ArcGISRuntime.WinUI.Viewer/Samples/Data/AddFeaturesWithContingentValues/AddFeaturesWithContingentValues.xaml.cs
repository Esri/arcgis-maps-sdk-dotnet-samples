...
namespace ArcGISMapsSDK.WinUI.Samples.AddFeaturesWithContingentValues
{
    ...
    [ArcGISMapsSDK.Samples.Shared.Attributes.OfflineData("e12b54ea799f4606a2712157cf9f6e41", "b5106355f1634b8996e634c04b6a930a")]
    public partial class AddFeaturesWithContingentValues
    {
        ...
        private async Task Initialize()
        {
            ...
            FeatureAttributesPanel.RegisterPropertyChangedCallback(UIElement.VisibilityProperty, FeatureAttributesPanel_IsVisibleChanged);
        ...
        private async Task CreateNewEmptyFeature(GeoViewInputEventArgs e)
        {
            try
            {
                ...
                if (FeatureAttributesPanel.Visibility != Visibility.Visible)
                {
        ...
        private async Task UpdateField(string field, object value)
        {
            try
            {
                ...
                switch (field)
                {
                    ...
                    default:
                        await new MessageDialog2($"{field} not found in any of the data dictionaries.", "Error").ShowAsync();
                        break;
                }
            }
            catch (Exception e)
        ...
        private async Task SaveFeature()
        {
            ...
            {
                await new MessageDialog2($"Error saving feature. {numberOfViolations} violation(s) in field group(s) {string.Join(", ", fieldGroupNames)}.", "Error").ShowAsync();
            }
        }
        ...
        private void StatusCombo_Selected(object sender, RoutedEventArgs e)
        {
            ...
            _ = UpdateField("Status", StatusCombo.SelectedItem);
        ...
        {
            // Update the feature's attribute map with the selection.
            _ = UpdateField("Protection", ProtectionCombo.SelectedItem);
            _ = SetBufferSizeSliderRange();
        }

        private void BufferSizeSlider_ValueChanged(object sender, Microsoft.UI.Xaml.Controls.Primitives.RangeBaseValueChangedEventArgs e)
        {
            // Update the feature's buffer size with the selected value.
        ...
        private void FeatureAttributesPanel_IsVisibleChanged(DependencyObject sender, DependencyProperty dp)
        {
