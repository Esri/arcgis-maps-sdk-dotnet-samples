...
2. Load the first `GeodatabaseFeatureTable` as an `FeatureTable`.
...
5. Create a new `Feature` using `FeatureTable.createFeature()`
6. Get the first field by name using `FeatureTable.field(forName:)`.
