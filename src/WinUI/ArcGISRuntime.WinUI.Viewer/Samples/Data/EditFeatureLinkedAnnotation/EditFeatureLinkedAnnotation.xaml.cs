...
namespace ArcGISRuntime.WinUI.Samples.EditFeatureLinkedAnnotation
{
    ...
    public partial class EditFeatureLinkedAnnotation
    {
        ...
        private void ShowEditableAttributes()
        {
            ...
            AttributesBorder.Visibility = Microsoft.UI.Xaml.Visibility.Visible;
        ...
        private void OkClick(object sender, Microsoft.UI.Xaml.RoutedEventArgs e)
        {
            _ = OkClickTask(sender, e);
        }

        private async Task OkClickTask(object sender, Microsoft.UI.Xaml.RoutedEventArgs e)
        {
            try
            {
