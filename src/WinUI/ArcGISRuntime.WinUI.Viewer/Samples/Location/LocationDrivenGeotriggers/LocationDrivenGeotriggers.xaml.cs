...
namespace ArcGISRuntime.WinUI.Samples.LocationDrivenGeotriggers
{
    ...
    public partial class LocationDrivenGeotriggers
    {
        ...
        public ObservableCollection<GeotriggerFeature> _displayedFeatures = new ObservableCollection<GeotriggerFeature>();
        ...
        private void HandleGeotriggerNotification(object sender, GeotriggerNotificationInfo info)
        {
            ...
            DispatcherQueue.TryEnqueue(Microsoft.UI.Dispatching.DispatcherQueuePriority.Normal, async () =>
            {
                if (info is FenceGeotriggerNotificationInfo fenceInfo)
                {
                    ...
                    Features.Source = _displayedFeatures.GroupBy(f => f.Source);
                }
            });
        }
        ...
        private void DisplayData(GeotriggerFeature geotriggerFeature)
        {
            ...
            NameLabel.Text = geotriggerFeature.Name;
        ...
        {
            if (e.ClickedItem is GeotriggerFeature feature)
            {
                DisplayData(feature);
            }
        }
