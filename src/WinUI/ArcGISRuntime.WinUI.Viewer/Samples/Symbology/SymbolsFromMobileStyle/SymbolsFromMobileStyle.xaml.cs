...
namespace ArcGISRuntime.WinUI.Samples.SymbolsFromMobileStyle
{
    ...
    public partial class SymbolsFromMobileStyle
    {
        ...
        private void SymbolPropertyChanged(object sender, SelectionChangedEventArgs e)
        {
            _ = SymbolPropertyChangedTask(sender, e);
        }

        private async Task SymbolPropertyChangedTask(object sender, SelectionChangedEventArgs e)
        {
