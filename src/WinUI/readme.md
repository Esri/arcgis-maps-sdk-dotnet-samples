...
* [Custom feature clustering](ArcGIS.WinUI.Viewer/Samples/Layers/CustomFeatureClustering) - Add client side custom feature reduction to a web map that does not have an existing defined feature reduction.
