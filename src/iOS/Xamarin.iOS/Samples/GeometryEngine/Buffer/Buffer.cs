...
namespace ArcGISRuntime.Samples.Buffer
{
    ...
    public class Buffer : UIViewController
    {
        ...
        private UILabel _theInstructionsUILabel;

        // Create UITextField to enter a buffer value (in miles). 
        private UITextField _theBufferUITextField;
        ...
        public override void ViewDidLayoutSubviews()
        {
            ...
            _theInstructionsUILabel.Frame = new CoreGraphics.CGRect(0, _yPageOffset, View.Bounds.Width, 40);

            // Setup the visual frame for the buffer value UITextField.
            _theBufferUITextField.Frame = new CoreGraphics.CGRect(150, _yPageOffset, View.Bounds.Width, 40);
        ...
        private void OnMapViewTapped(object sender, GeoViewInputEventArgs e)
        {
            try
            {
                ...
                double theBufferInMiles = System.Convert.ToDouble(_theBufferUITextField.Text);
        ...
        private void CreateLayout()
        {
            ...
            _theInstructionsUILabel = new UILabel();
            _theInstructionsUILabel.Text = "Buffer (miles):";
            _theInstructionsUILabel.AdjustsFontSizeToFitWidth = true;
            _theInstructionsUILabel.BackgroundColor = UIColor.White;

            // Create UITextFiled for the buffer value.
            _theBufferUITextField = new UITextField();
            _theBufferUITextField.Text = "10";
            _theBufferUITextField.AdjustsFontSizeToFitWidth = true;
            _theBufferUITextField.BackgroundColor = UIColor.White;
            // - Allow pressing 'return' to dismiss the keyboard
            _theBufferUITextField.ShouldReturn += (textField) => { textField.ResignFirstResponder(); return true; };

            // Add the MapView and other controls to the page.
            View.AddSubviews(_myMapView, _theInstructionsUILabel, _theBufferUITextField);
        }
    }
}