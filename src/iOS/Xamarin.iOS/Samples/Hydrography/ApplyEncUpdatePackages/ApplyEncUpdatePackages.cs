...
namespace ArcGISRuntimeXamarin.Samples.ApplyEncUpdatePackages
{
    [Register("ApplyEncUpdatePackages")]
    public class ApplyEncUpdatePackages : UIViewController
    {
        // Create and hold reference to the used MapView
        private MapView _myMapView = new MapView();

        public ApplyEncUpdatePackages()
        {
            Title = "Apply ENC Update Packages";
        }
