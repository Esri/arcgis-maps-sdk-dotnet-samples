...
namespace ArcGISRuntime.Samples.MapImageLayerTables
{
    ...
    public class MapImageLayerTables : UIViewController
    {
        ...
        {
            // Define the visual frame for the map view.
            _myMapView.Frame = new CoreGraphics.CGRect(0, 0, View.Bounds.Width, View.Bounds.Height - 80);

            // Define the visual frame for the table view.
            _tableView.Frame = new CoreGraphics.CGRect(0, _myMapView.Frame.Height, View.Bounds.Width, 80);
